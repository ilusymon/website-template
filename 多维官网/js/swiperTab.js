...
* */
function tabs(obj,swiperObj,className,simulateTouch,effect) {
    var tabSwiper = new Swiper(swiperObj, {
        simulateTouch : simulateTouch || true,//禁止鼠标模拟
        effect : effect || 'slide',//切换效果
        speed : 500, //滑动速度，单位ms
        autoplay:{
         delay:5000,
        ...
        on: {
          ...
          slideChangeTransitionEnd: function(){
            ...
            $(obj).eq(this.activeIndex).addClass(className);/*activeIndex是过渡后的slide索引*/
            swiperAnimate(this);
          }
        }
    });
